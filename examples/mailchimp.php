...
<form action="//<?php echo $mc_user; ?>.us12.list-manage.com/subscribe/post?u=bbb495842a4ea2ed316ff0cba&amp;id=<?php echo $mc_id; ?>" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	<div id="mc_embed_signup_scroll">
		...
		<div style="position: absolute; left: -5000px;" aria-hidden="true">
			<input type="text" name="b_bbb495842a4ea2ed316ff0cba_<?php echo $mc_id; ?>" tabindex="-1" value="" />
		</div>
		<div class="clear">
